...
?>
    ...
    <body>
        ...
        <div class="col-6 offset-3 text-center" id="title">
        ...
        <button id="login" type="button" class="hover col-6 offset-3  btn btn-primary" data-toggle="modal" data-target="#connexionmodal">Log In</button>
        <?php
        ...
        <div class="">
              <span class="lien col-6 offset-3 text-center" >Votre Lien:
